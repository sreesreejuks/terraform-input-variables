...
# Variable to specify project and environment information
# Type: Map - A map of project name and environment (e.g., dev, prod) for the project
variable "project_environment" {
  description = "Project name and environment"
  type        = map(string)
  default     = {
    Name        = "Tf_EC2_instance"
    project     = "project-alpha"   # Name of the project
    environment = "dev"             # Environment (e.g., dev, prod)
  }
}